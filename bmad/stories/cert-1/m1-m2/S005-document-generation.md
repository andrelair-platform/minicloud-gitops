...
- [x] AC-6: MinIO bucket lifecycle rule 7-year retention — deferred; MinIO not wired in dev cluster (MINIO_ENDPOINT empty). Implement when controller MinIO exposed or dedicated k8s MinIO deployed.
